                ...
                <div className="loginPage">
                    <div className="loginCard">
                        ...
                        <div style={{ paddingLeft: "20px" }}>
                            ...
                            <div style={{ cursor: "pointer", display: "inline-block", color: "#5bb2fc", paddingLeft: "220px" }}>Forgot ?</div>
                        </div>
                    ...
                    Login
                        ...
                        <div style={{ marginTop: "30px" }}>
                            ...
                            <div style={{ content: "center" }}>
                                ...
                                <div style={{ cursor: "pointer", display: "inline-block", color: "#5bb2fc" }}>Log In</div>
                            </div>
